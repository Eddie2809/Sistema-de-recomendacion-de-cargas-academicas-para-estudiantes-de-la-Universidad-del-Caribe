...
class ResultadosEstadisticas(ctk.CTkToplevel):
    def __init__(self,*args,datos,controlador,**kwargs):
        ...
        fig, axs = plt.subplots(1,2, dpi= 80, figsize=(20,5), sharey= True, facecolor= self.estilo.COLOR_FONDO)
        ...
        self.contenedorGraficas = ctk.CTkFrame(master=self.container,height=300,width=1200,fg_color=self.estilo.COLOR_FONDO, bg_color=self.estilo.COLOR_FONDO)
